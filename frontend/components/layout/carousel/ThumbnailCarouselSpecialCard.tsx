...
// Use the same type as RouteSpecialSection expects
export type Special = {
  image: string;
  specialName: string;
  price?: string;
...
const ThumbnailCarouselSpecialCard: React.FC<PropType> = (props) => {
...
export default ThumbnailCarouselSpecialCard;
