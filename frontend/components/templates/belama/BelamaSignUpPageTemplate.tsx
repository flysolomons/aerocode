...
export default function BelamaSignUpTemplate({
  ...
  const [isSeatSelectionPopOverOpen, setIsSeatSelectionPopOveOpen] =
    useState<boolean>();
          ...
          >
            ...
            >
              {seatOptions.map((seat) => (
                <div
                  key={seat}
                  className="text-gray-500 p-3 hover:bg-yellow-50 cursor-pointer"
          ...
          <form onSubmit={handleSubmit}>
            <div className="py-12 space-y-8">
              <div className="border-2 border-gray-100 p-4 rounded-md bg-white bg-[url(/traditional_ring.png)] bg-center">
                ...
                <div className="float-right">
                  <h1 className="font-bold text-xl -mt-12 lg:text-2xl lg:-mt-14 lg:mr-6">
                    SBD ${price}
                  </h1>
                  <p className="text-xs text-gray-400 md:text-sm lg:text-sm">
                    Billed Annually
                  </p>
                </div>
              </div>
                ...
                <>
                  {membershipType === "business" && (
                    <div className="border p-4 rounded shadow mb-4 bg-white">
                      ...
                      <span className="text-gray-400 text-xs md:text-sm lg:text-sm ">
                        (Up to 3 Persons)
                      </span>
                      {[1, 2, 3].map((member) => (
                  ...
                  {membershipType === "family" && (
                    <div className="border p-4 rounded shadow mb-4 bg-white">
                      ...
                      <h4 className="font-medium mt-3 mb-2 text-gray-500">
                        Adult
                      </h4>
                      {[1, 2].map((adult) => (
