...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('core', '0021_genericpage_svg_icon'),
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('file', models.FileField(upload_to='images', validators=[django.core.validators.FileExtensionValidator(allowed_extensions=['svg'])])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('image', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='renditions', to='core.svgimage')),
            ],
            options={
